...
# In notebook environments, you can display the map object by evaluating `m`.
# In terminal execution, this script prints summary outputs and saves charts to HTML.